...
export const HighImpactHero: React.FC<Page['hero']> = (props) => {
  ...
  return (
    <div
      id={"hero"}
      className="relative -mt-24.5 pt-56 pb-24 w-full max-w-[100vw] overflow-hidden flex items-center text-white min-h-screen md:min-h-[700px] lg:min-h-screen gradient-bg"
    >
